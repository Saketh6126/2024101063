...
class Board:
    ...
    def _create_properties(self):
        ...
        # 1. Define the raw data (Color Group, Name, Position, Price, Rent)
        property_data = [
            ("brown",      "Mediterranean Avenue",   1,  60,  2),
            ("brown",      "Baltic Avenue",          3,  60,  4),
            ("light_blue", "Oriental Avenue",        6,  100, 6),
            ("light_blue", "Vermont Avenue",         8,  100, 6),
            ("light_blue", "Connecticut Avenue",     9,  120, 8),
            ("pink",       "St. Charles Place",      11, 140, 10),
            ("pink",       "States Avenue",          13, 140, 10),
            ("pink",       "Virginia Avenue",        14, 160, 12),
            ("orange",     "St. James Place",        16, 180, 14),
            ("orange",     "Tennessee Avenue",       18, 180, 14),
            ("orange",     "New York Avenue",        19, 200, 16),
            ("red",        "Kentucky Avenue",        21, 220, 18),
            ("red",        "Indiana Avenue",         23, 220, 18),
            ("red",        "Illinois Avenue",        24, 240, 20),
            ("yellow",     "Atlantic Avenue",        26, 260, 22),
            ("yellow",     "Ventnor Avenue",         27, 260, 22),
            ("yellow",     "Marvin Gardens",         29, 280, 24),
            ("green",      "Pacific Avenue",         31, 300, 26),
            ("green",      "North Carolina Avenue",  32, 300, 26),
            ("green",      "Pennsylvania Avenue",    34, 320, 28),
            ("dark_blue",  "Park Place",             37, 350, 35),
            ("dark_blue",  "Boardwalk",              39, 400, 50),
        ]

        properties = []
        # 2. Creating instance of properties and adding to groups
        for color, name, pos, price, rent in property_data:
            prop = Property(name, pos, price, rent)
            g[color].add_property(prop)
